...
abstract class TestRepository {
  Future<DataResult<ObjectTestModel>> getById({
    required String id,
  });
  Future<DataResult<List<ObjectTestModel>>> getAll();
...
class TestRepositoryImpl implements TestRepository {
  ...
  @override
  Future<DataResult<List<ObjectTestModel>>> getAll() async {
    ...
    return SuccessDataResult(data: apiResponseModel.data!, message: "$runtimeType getAll()");
  }
  ...
  Future<DataResult<ObjectTestModel>> getById({
    ...
    if (apiResponseModel.data == null) {
      ...
      AppLogger.instance.log("$runtimeType getById() SUCCESS but [Null remote data]");
      return SuccessDataResult(data: testModel, message: "$runtimeType getById() [Null remote data]");
    }
    AppLogger.instance.log("$runtimeType getById() SUCCESS");
    return SuccessDataResult(data: apiResponseModel.data!, message: "$runtimeType getById()");
  }
}
